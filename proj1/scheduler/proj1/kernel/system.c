 ...
 *                               sched_proc                                  *
 *===========================================================================*/
PUBLIC int sched_proc(struct proc *rp, int priority, unsigned quantum)
{
    ...
    printf("sched_proc: %d\t + %d\t = %d\n", rp->ntickets, priority, rp->ntickets + priority);

    if (rp->ntickets + priority > 100)
        rp->ntickets = 100;
    else if (rp->ntickets + priority < 1)
        rp->ntickets = 1;
    else
        rp->ntickets += priority;
